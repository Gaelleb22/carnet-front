...
const routes: Routes = [
  ...
  {path: 'mes-recettes/detail/:uuid', component: DetailComponent, canActivate: [StatutConnecteService] },
  {path: 'mes-recettes/new', component: NouvelleComponent, canActivate: [StatutConnecteService]},
